...
#boxfl(bottom)[== #wolf Catalisi e catalizzatori <senza_numero>
...
Dal punto di vista della termodinamica, le reazioni chimiche si suddividono principalmente in reazioni endoergoniche e esoergoniche. Le reazioni endoergoniche sono caratterizzate dal fatto che i prodotti possiedono un contenuto energetico maggiore rispetto ai reagenti. Di conseguenza, queste reazioni possono avvenire esclusivamente se viene fornita energia dall'esterno per colmare tale differenza.
