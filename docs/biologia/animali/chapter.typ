...
#intro[Il regno animale include organismi pluricellulari eterotrofi che si riproducono prevalentemente sessualmente e le cui cellule, a differenza di quelle vegetali, sono prive di parete cellulare. Si ritiene che gli animali abbiano avuto origine da protisti marini che formavano colonie, simili alle odierne spugne. Nel corso dell'evoluzione, hanno dato vita a una straordinaria varietà di forme caratterizzate da livelli di complessità sempre più elevati, legati a una progressiva organizzazione e specializzazione cellulare nei tessuti. La crescente complessità è evidente nei vari _phyla_ animali, che riflettono questa tendenza evolutiva.]
...
#boxbr[== #wolf Altri _phyla_ di animali <senza_numero>
