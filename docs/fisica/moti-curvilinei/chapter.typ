...
#intro[Lo studio dei moti curvilinei, caratterizzati da traiettorie che seguono linee curve, consente di ampliare i concetti di velocità e accelerazione, applicandoli non solo a distanze lineari ma anche angolari. L'analisi del moto circolare uniforme, il più semplice dei moti curvilinei, introduce grandezze fondamentali quali il periodo e la frequenza della rotazione, oltre a un movimento derivato, denominato moto armonico.]
...
#boxfl(bottom)[== #wolf La velocità angolare <senza_numero>
