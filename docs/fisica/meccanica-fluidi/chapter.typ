...
#intro[La meccanica dei fluidi si occupa di analizzare il comportamento dei fluidi sia in movimento (fluidodinamica) sia in condizione di quiete (idrostatica). 
...
#boxfl(bottom)[== #wolf Le unità di misura della pressione atmosferica <senza_numero>
