...
#intro[La luce costituisce solo una piccola parte dello spettro elettromagnetico, ma per molti aspetti può essere considerata la più rilevante.  

Assieme al suono, rappresenta per l'essere umano uno dei principali canali di scoperta e comprensione del mondo fisico. Gli occhi, grazie alla luce riflessa dagli oggetti circostanti, riescono a captare un'enorme quantità di informazioni che ci permettono di interpretare l'ambiente.  
...
#boxfl(bottom)[== #wolf La misura della velocità della luce <senza_numero>
...
Alla fine del XVII secolo coesistevano due teorie principali sulla natura della luce: la teoria ondulatoria e quella corpuscolare. Secondo la teoria ondulatoria, proposta dal fisico olandese C. Huygens (1629-1695), la luce era vista come un insieme di onde generate dalla vibrazione di un mezzo indefinito, l'etere, che si pensava permeasse l'intero universo. I colori venivano attribuiti alle differenze di frequenza delle onde luminose. La teoria corpuscolare, formulata quasi nello stesso periodo da Newton, ipotizzava invece che la luce fosse composta da particelle dotate di diversa massa (da cui derivavano i colori), che si muovevano in linea retta. Inizialmente, la teoria corpuscolare guadagnò maggior consenso per la sua semplicità e per le difficoltà legate alla definizione dell'etere, ma all'inizio del XIX secolo lo studio dei fenomeni di interferenza e diffrazione — propri delle onde — portò la teoria ondulatoria a prevalere su quella corpuscolare.  

Nella seconda metà dell'Ottocento, con la scoperta del campo elettromagnetico e della sua propagazione ondulatoria, si capì che la velocità di propagazione nel vuoto coincideva con quella della luce. Maxwell formulò allora l'ipotesi, tuttora valida, secondo cui la luce è una forma di onda elettromagnetica appartenente a un determinato intervallo di frequenze.  

Le onde luminose sono onde trasversali: i campi elettrico e magnetico vibrano in piani tra loro perpendicolari e anch'essi perpendicolari alla direzione del raggio luminoso. Nel vuoto, tali onde viaggiano in linea retta a una velocità di circa 300.000.000 m/s.  

La luce corrisponde alla porzione dello spettro elettromagnetico percepibile dall'occhio umano, caratterizzata da frequenze comprese tra circa 4,1 x 10¹⁴ Hz (violetto estremo) e 7,5 x 10¹⁴ Hz (rosso estremo). All'interno di questo intervallo si collocano tutte le frequenze corrispondenti ai colori dello spettro visibile.  

La luce bianca è comunemente associata a quella proveniente dal Sole o all'emissione di una lampadina a incandescenza. In realtà, essa è composta dall'insieme di tutti i colori dello spettro. L'ottica è la branca della fisica che studia i fenomeni legati all'emissione, alla propagazione e alla rilevazione della luce.

Le caratteristiche della luce riflettono il comportamento tipico delle onde. Quando interagisce con la materia, essa dà origine a fenomeni come riflessione, rifrazione, diffrazione e interferenza.

Per analizzare i fenomeni di riflessione e rifrazione, che si verificano quando la luce incontra una superficie uniforme, si utilizza spesso un modello semplificato. Questo modello assume che la luce si propaghi in linea retta e che i raggi siano indipendenti tra loro, non considerando la natura ondulatoria della luce. Tale semplificazione costituisce la base dell'ottica geometrica.
...
#boxfl(bottom)[== #wolf I colori degli oggetti <senza_numero>
...
Un esempio classico è il Sole, una sorgente luminosa; mentre i pianeti, visibili grazie alla luce solare riflessa, sono considerati corpi illuminati.

Nel Sistema Internazionale sono state definite grandezze misurabili per quantificare la luce emessa o ricevuta da un corpo. L'intensità luminosa rappresenta la quantità di energia emessa da una sorgente luminosa nell'unità di tempo e in tutte le direzioni. La sua unità di misura è la candela (cd), che corrisponde all'intensità luminosa prodotta da una lampada di riferimento depositata presso l'Archivio Pesi e Misure di Parigi. Questa è pari a 1/60 dell'intensità luminosa emessa da un centimetro quadrato di un corpo portato alla temperatura di fusione del platino a pressione standard.

Per i corpi illuminati si definisce l'intensità di illuminazione come l'energia che raggiunge una superficie nell'unità di tempo. Essa si misura in lux (lx), definito come il livello di illuminazione prodotto da una sorgente luminosa di intensità pari a una candela su una superficie perpendicolare alla direzione dei raggi luminosi posta a 1 metro dalla sorgente. L'intensità di illuminazione diminuisce progressivamente con l'aumentare della distanza tra la superficie illuminata e la sorgente.

== La riflessione e la rifrazione della luce

La riflessione e la rifrazione della luce possono essere efficacemente spiegate supponendo che la luce si propaghi sotto forma di raggi rettilinei, secondo i principi dell'ottica geometrica.
...
Negli specchi convessi, invece, le immagini, costruite mediante il prolungamento dei raggi riflessi oltre la superficie dello specchio, sono costantemente virtuali, rimpicciolite e dritte.
...
Quando un fascio di luce bianca, come la luce solare, viene fatto passare attraverso un prisma di vetro di forma triangolare, all'uscita del prisma la luce si presenta scomposta nei colori fondamentali dello spettro visibile, evidenziando un fenomeno noto come dispersione della luce. Questo processo è spiegato attraverso il principio della rifrazione.

La velocità della luce all'interno di un mezzo materiale, quale il vetro, varia leggermente in funzione della lunghezza d'onda. Poiché ogni lunghezza d'onda corrisponde a uno specifico colore e l'indice di rifrazione dipende dalla velocità della luce nel mezzo, i raggi luminosi emergenti dal prisma subiscono angoli di rifrazione differenti in base al colore: lunghezze d'onda minori determinano angoli di rifrazione maggiori. 

Il fenomeno fu analizzato per la prima volta nel 1666 da Isaac Newton, celebre per i suoi contributi alla meccanica e pionieristico anche nel campo dell'ottica. Attraverso un esperimento innovativo, Newton dimostrò che la luce bianca è composta da una gamma di colori che spaziano dal rosso al violetto. Per validare questa scoperta, fece passare un fascio di luce colorata, già scomposta con un primo prisma, attraverso un secondo prisma. In questo caso la luce non subiva ulteriori alterazioni, confermando che la luce bianca è una combinazione di colori distinti. Inoltre, Newton evidenziò la reversibilità del fenomeno: se la luce scomposta viene fatta attraversare un secondo prisma, orientato in senso opposto rispetto al primo, il ventaglio cromatico si ricompone restituendo nuovamente la luce bianca.

La dispersione nei colori dello spettro è fondamentale per comprendere fenomeni naturali come l'arcobaleno. Quando la luce solare interagisce con le gocce d'acqua sospese nell'atmosfera o con quelle della pioggia, che agiscono come piccoli prismi, essa si scompone nei colori dello spettro formando l'arco colorato visibile nel cielo. Lo spettro luminoso ottenuto dalla luce solare è generalmente continuo e appare come una striscia uniforme composta da una gradazione cromatica completa. Anche le lampadine a incandescenza producono uno spettro continuo.

Diversamente, le sostanze gassose sottoposte a elevata temperatura generano uno spettro di emissione caratterizzato da righe colorate distinte su uno sfondo scuro. Attraverso l'analisi di questi spettri di emissione è possibile determinare la composizione chimica del materiale riscaldato. Ogni elemento presenta una specifica configurazione spettrale che può essere utilizzata come firma identificativa nella sua analisi chimica.

== Le lenti e gli strumenti ottici

Le lenti, componenti fondamentali di strumenti ottici come microscopi e telescopi, oppure utilizzate per migliorare le capacità visive dell'occhio umano, sono realizzate in materiali trasparenti, come vetro o plastica, e delimitate da superfici sferiche capaci di rifrangere la luce.

Mentre negli specchi le immagini vengono formate attraverso le leggi della riflessione, nelle lenti il principio sfruttato è quello della rifrazione. Attraversando le superfici delle lenti, i raggi luminosi subiscono una deviazione che genera immagini, le quali possono essere reali o virtuali, ingrandite o ridotte, diritte o capovolte in base al tipo di lente e alla distanza tra quest'ultima e l'oggetto osservato. Sebbene esistano lenti di diverse forme, l'analisi si concentra prevalentemente sulle lenti sferiche, che si dividono in convergenti e divergenti.
...
Per la formazione delle immagini tramite una lente, si applicano principi analoghi a quelli impiegati nella formazione delle immagini riflesse da uno specchio. 

In particolare, è possibile distinguere due tipologie di raggi luminosi derivanti dal punto oggetto che attraversano la lente subendo rifrazione: il raggio parallelo all'asse ottico, che dopo essere stato rifratto converge nel fuoco della lente, e il raggio che attraversa il centro della lente senza subire alcuna deviazione.
...
A causa della natura prismatica dei bordi delle lenti, i diversi colori che costituiscono la luce bianca vengono rifratti con angoli differenti al passaggio attraverso una lente. Questo fenomeno dà origine a immagini circondate da un alone colorato ed è noto come aberrazione cromatica.

Per eliminare questo effetto indesiderato, si impiega una combinazione di lenti in cui le proprietà dispersive di ciascuna si compensano reciprocamente. Solitamente si adottano accoppiamenti di lenti concave e convesse con differenti indici di rifrazione, così che l'aberrazione introdotta da una lente venga annullata da quella dell'altra.

Le lenti così combinate sono definite "lenti acromatiche" e rappresentano un elemento fondamentale nella progettazione della maggior parte degli strumenti ottici.

=== L'occhio e i difetti della vista

L'occhio è l'organo deputato alla funzione visiva ed è caratterizzato da una struttura quasi sferica, denominata bulbo oculare, rivestita da tre strati principali. Lo strato più esterno comprende la sclera, opaca e fibrosa, che anteriormente prende il nome di cornea, caratterizzata dalla sua trasparenza. Lo strato intermedio è la coroide, che nella parte anteriore si differenzia in corpo ciliare e iride, formando l'orifizio della pupilla. Lo strato più interno, infine, è costituito dalla retina, tessuto nervoso contenente i recettori fotosensibili noti come coni e bastoncelli. I coni sono responsabili della percezione dei colori e della visione diurna, mentre i bastoncelli mediatori della visione in condizioni di scarsa illuminazione.

La retina è collegata ai centri visivi della corteccia cerebrale tramite il nervo ottico. All'interno del bulbo oculare si trovano i mezzi di rifrazione della luce: l'umore acqueo, il cristallino e il corpo vitreo, tutti fondamentali per il corretto funzionamento del sistema visivo.

Il cristallino rappresenta la lente naturale dell'occhio, caratterizzato da una conformazione biconvessa e posizionato tra la camera anteriore e il corpo vitreo, una sostanza gelatinosa che riempie lo spazio tra il cristallino stesso e la retina. In condizioni di visione normale, i raggi luminosi attraversano il cristallino e la cornea per convergere sulla retina, consentendo la percezione visiva.

Una delle principali proprietà del cristallino è la capacità di modificare la propria curvatura grazie all'azione dei muscoli ciliari, permettendo così un adattamento della messa a fuoco su oggetti posti a diverse distanze.

Nei principali difetti refrattivi, quali miopia e ipermetropia, la focalizzazione dell'immagine avviene rispettivamente davanti o dietro la retina. La miopia, spesso dovuta a un prolungamento anomalo del bulbo oculare, si corregge mediante l'utilizzo di lenti divergenti che deviano i raggi luminosi prima del loro ingresso nell'occhio, estendendone il percorso fino alla retina. Al contrario, l'ipermetropia, causata generalmente da un accorciamento del bulbo oculare, richiede lenti convergenti che riducono il tragitto dei raggi luminosi, garantendone la focalizzazione sulla retina.
...
Si distingue inoltre il cannocchiale dal telescopio riflettore, sebbene entrambi siano destinati all'osservazione di oggetti lontani. La differenza principale risiede nell'utilizzo di uno specchio concavo al posto dell'obiettivo nel telescopio, capace di formare immagini riflettendo la luce.

Passando al microscopio, esso è progettato per esaminare oggetti di dimensioni estremamente ridotte. Un microscopio ottico basilare utilizza due lenti convergenti: l'obiettivo e l'oculare. L'oggetto analizzato viene posizionato poco oltre il fuoco dell'obiettivo, producendo un'immagine ingrandita e rovesciata. L'oculare trasforma questa immagine in una rappresentazione virtuale ulteriormente ingrandita e orientata in senso opposto rispetto alla prima.

Un microscopio ottico tradizionale è in grado di ottenere ingrandimenti dell'ordine di migliaia di volte senza perdita significativa di dettagli, permettendo così lo studio di organismi o strutture della dimensione di un milionesimo di millimetro, come i batteri. Tuttavia, per raggiungere livelli superiori di ingrandimento – ad esempio per osservare gli atomi – è necessario ricorrere a tecnologie differenti, come il microscopio elettronico.
...
Per esaminare il fenomeno della diffrazione, si utilizza una sorgente di luce monocromatica per illuminare un oggetto di dimensioni ridotte, proiettando la sua ombra su uno schermo. Osservando attentamente quest'ombra, si nota che non è completamente buia: presenta zone chiare e scure lungo il bordo. In tali condizioni, l'ostacolo si comporta come una sorgente di onde circolari.

Un esperimento analogo prevede l'impiego di una fenditura al posto dell'ostacolo. La luce che attraversa la fenditura genera una macchia luminosa circondata da una serie di zone chiare e scure, piuttosto che essere concentrata in un'unica area. Quando la diffrazione viene osservata su una doppia fenditura o su una serie di fenditure, le onde diffratte interferiscono tra loro producendo frange alternate di luce e buio. Questi pattern visibili, noti come figure di interferenza, derivano dalla sovrapposizione costruttiva o distruttiva delle onde generate dalle fenditure.

Le frange luminose sono il risultato della sovrapposizione costruttiva (interferenza in fase), che aumenta l'ampiezza dell'onda, mentre le zone buie derivano dall'interferenza distruttiva (onde fuori fase), che porta a un'annullamento dell'ampiezza.

== L'effetto Doppler e lo spostamento verso il rosso

Per quanto riguarda l'effetto Doppler e lo spostamento verso il rosso, nel caso della radiazione luminosa, l'effetto Doppler interviene quando la sorgente della radiazione e l'osservatore sono in movimento relativo. Questo fenomeno induce variazioni nel colore percepito: se la sorgente e l'osservatore si avvicinano, la frequenza aumenta determinando uno spostamento verso l'estremità viola dello spettro (blueshift); viceversa, se si allontanano, la frequenza diminuisce causando uno spostamento verso il rosso (redshift).

L'effetto Doppler è spesso associato alle teorie astronomiche sull'espansione dell'Universo. Infatti, le righe spettrali della luce proveniente da stelle e galassie lontane appaiono spostate verso il rosso rispetto alle righe spettrali della luce di sorgenti terrestri. Questo fenomeno suggerisce che le sorgenti cosmiche di luce stanno progressivamente allontanandosi dalla nostra galassia.

Va tuttavia notato che il redshift cosmologico differisce concettualmente dal semplice effetto Doppler: esso è il risultato dell'espansione dello spazio stesso su scala cosmica, piuttosto che del moto relativo tra le sorgenti di luce e l'osservatore.

Nel caso in cui la luce subisca un cambiamento di colore, ovvero di energia, ciò avviene esclusivamente perché la sorgente che la emette si muove rispetto all'osservatore. Una volta che l'onda è stata generata, qualsiasi variazione nella situazione della sorgente non ha più alcun effetto sul colore della radiazione percepita.

Quando si parla di un universo in espansione, invece, lo scenario si complica: oltre al movimento intrinseco della sorgente, bisogna considerare il fatto che durante il tragitto percorso dalla luce verso l'osservatore, lo spaziotempo stesso si espande. Questa dilatazione dello spaziotempo provoca una variazione continua nella lunghezza d'onda della luce, influenzando la sua energia anche dopo che è stata emessa dalla sorgente.

In un cosmo in espansione, il redshift fornisce informazioni sia sulla distanza che la luce ha attraversato sia sull'età delle sorgenti osservate. Il redshift cosmologico, infatti, è una prova diretta dell'allontanamento delle galassie dalla Via Lattea e quindi del fatto che l'universo sia in continua espansione. Lo spostamento verso il rosso nelle galassie lontane aumenta proporzionalmente alla loro distanza dalla Terra, come stabilito dalla legge di Hubble. Analizzando l'entità di tale spostamento, è possibile calcolare la velocità con cui una galassia o una stella si sta allontanando dal nostro pianeta.
