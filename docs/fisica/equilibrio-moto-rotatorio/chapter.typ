...
#intro[Un corpo si trova in equilibrio quando le forze a cui è sottoposto non modificano il suo stato di quiete. La branca della meccanica che si occupa di studiare e determinare le condizioni di equilibrio dei corpi prende il nome di statica.
...
#boxfl(bottom)[== #wolf Le leve <senza_numero>
