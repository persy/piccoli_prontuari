...
#intro[La termodinamica è quel ramo della fisica che analizza gli scambi di calore tra un sistema e l'ambiente circostante, basandosi su due principi fondamentali. Il primo principio, noto anche come principio di conservazione dell'energia, stabilisce che l'energia non può essere né creata né distrutta, ma viene conservata e può manifestarsi in forme diverse. Il secondo principio, invece, nella sua formulazione più semplice afferma che il calore non può trasferirsi spontaneamente da un corpo più freddo a uno più caldo.

Questo secondo principio assume particolare importanza per il funzionamento delle macchine termiche, progettate per convertire il calore in lavoro. Esso distingue tra la possibilità di trasformare integralmente il lavoro in calore, sempre possibile, e l'impossibilità di effettuare il processo inverso senza perdite.

Con l'introduzione dell'entropia, una grandezza che misura il grado di disordine di un sistema, il secondo principio si arricchisce ulteriormente: in un sistema isolato, l'entropia tende ad aumentare. Solo nei processi reversibili essa si mantiene costante.

Se si considera l'Universo come un sistema termodinamico isolato, privo di scambi di calore con l'esterno, l'entropia totale dell'Universo tende progressivamente a crescere. Questo riflette il carattere irreversibile dei processi naturali, comunemente definiti spontanei.]

== I sistemi termodinamici

La termodinamica, il cui nome deriva dalle parole greche *thermon* (calore) e *dinamis* (forza), si occupa principalmente dei fenomeni legati agli scambi di calore tra un sistema e il suo ambiente. Studia le trasformazioni di calore in lavoro e viceversa, così come le conversioni tra le diverse forme di energia in sistemi in interazione.

Un sistema termodinamico è definito come una porzione di materia idealmente isolata dall'Universo esterno, che funge da ambiente. Questo approccio considera il sistema dal punto di vista macroscopico, ignorando la descrizione microscopica della sua struttura interna.

Le caratteristiche del sistema vengono descritte attraverso grandezze misurabili come temperatura, pressione e volume, note come coordinate termodinamiche. I fondamenti della termodinamica si basano su due principi generali: il primo e il secondo principio della termodinamica, validi per tutti i sistemi in natura indipendentemente dalle loro peculiarità interne.

Agli inizi del XIX secolo, la scienza del calore, nota anche come termologia, rappresentava un ambito autonomo della fisica. Sebbene già nel XVIII secolo fossero state inventate macchine capaci di trasformare il calore in lavoro, come le macchine a vapore, il legame teorico tra queste due grandezze fisiche rimaneva ancora poco chiaro. 

Nemmeno scienziati illustri quali Galileo e Newton, che pur si interessarono a questioni relative al calore, riuscirono a intuire il rapporto fra calore e lavoro. Questo concetto avrebbe poi avuto implicazioni enormi per la storia dell'umanità, costituendo la pietra angolare della rivoluzione industriale.

La termodinamica classica si basa su un insieme di conoscenze sviluppatesi lentamente, non senza difficoltà, lungo tutto il XIX secolo grazie al contributo di grandi studiosi come Sadi Carnot, James Joule, Lord Kelvin e altri. 

Originariamente nata per studiare le conversioni energetiche, la termodinamica ha ampliato i suoi orizzonti attraverso l'analisi dei processi e delle proprietà della materia. Oggi essa abbraccia numerosi campi della fisica, chimica e biologia, configurandosi come disciplina centrale per le sue molteplici connessioni con varie branche del sapere scientifico.
...
La maggior parte delle trasformazioni naturali sono irreversibili, poiché è impossibile eliminare completamente gli scambi di calore con l'esterno, spesso causati anche dagli attriti.

Una trasformazione termodinamica può avvenire mantenendo costante una delle tre coordinate principali. Si parla di trasformazione isotermica se la temperatura rimane invariata durante il processo, di trasformazione isobara se avviene a pressione costante e di trasformazione isocora, o isometrica, se il volume rimane costante.

Un caso particolare di trasformazione termodinamica è quella adiabatica, in cui il calore rimane costante, ovvero non si verificano scambi di calore tra il sistema e l'ambiente esterno.

=== Equivalenza calore-lavoro

L'equivalenza tra calore e lavoro rappresenta uno dei concetti fondamentali della termodinamica. Il calore è una forma di energia che si trasferisce tra due corpi a temperature diverse. È dimostrabile che compiendo un lavoro meccanico su un corpo se ne aumenta la temperatura e, di conseguenza, si genera calore. Ad esempio, il lavoro esercitato contro le forze di attrito produce calore, oppure comprimendo un gas in un recipiente si verifica un aumento di temperatura che genera calore.

Analogamente, fornendo calore a un corpo è possibile ottenere lavoro, come avviene nelle macchine termiche. In sintesi, calore e lavoro sono equivalenti e rappresentano due forme dello stesso principio energetico.
...
Tutti i corpi, indipendentemente dal loro stato di aggregazione, racchiudono una certa quantità di energia al loro interno. Questa energia è legata alle particelle che li costituiscono, siano esse atomi o molecole, vincolate tra loro da forze di diversa natura.

Si tratta di energie di varia origine, determinate dalle proprietà intrinseche del sistema. Tra queste rientrano il moto delle molecole e le forze intermolecolari, che includono energia di tipo elettrico, responsabile del legame degli elettroni con gli atomi; energia di tipo nucleare, che mantiene unite le particelle del nucleo; ed energia derivante dalla massa a riposo delle particelle che costituiscono il complesso struttura atomico-nucleare di ogni elemento.

Tutte queste forme di energia presenti in un corpo possono essere coinvolte in uno scambio durante una trasformazione e, nel loro insieme, vengono definite energia interna.

L'energia interna non comprende forme di energia che dipendono dallo stato globale del corpo, come l'energia cinetica relativa al suo movimento complessivo, o l'energia potenziale associata al corpo nella sua interezza, ad esempio l'energia potenziale gravitazionale quando esso è posto a una certa altezza rispetto al suolo.

La quantità di energia interna di un corpo varia in funzione dello stato del sistema stesso, influenzata, ad esempio, dalla temperatura e, in misura minore, dalla pressione. Tuttavia, nella termodinamica è di interesse particolare la variazione dell'energia interna durante una trasformazione termodinamica, piuttosto che il suo calcolo assoluto.
...
#boxfl(bottom)[== #wolf Il motore a combustione interna <senza_numero>
...
Il primo principio della termodinamica non introduce limitazioni teoriche al trasferimento di calore da un corpo più freddo a uno più caldo, poiché anche in questo caso il principio di conservazione dell'energia rimane valido.

Si può verificare questa affermazione con un semplice esperimento: ponendo un cubetto di acciaio freddo in un bicchiere di acqua calda, si osserva sperimentalmente che l'acciaio si riscalda mentre l'acqua si raffredda. 

Secondo il primo principio della termodinamica, l'acqua trasferisce parte della sua energia interna all'acciaio, causando il suo riscaldamento. Teoricamente, però, potrebbe succedere anche il contrario, ovvero che l'acqua aumenti ulteriormente la propria energia interna riscaldandosi, e l'acciaio si raffreddi ancora di più perdendo energia della stessa quantità. Anche questa possibilità sarebbe compatibile con il principio di conservazione dell'energia.

Tuttavia, questa osservazione ha determinato lo sviluppo del secondo principio della termodinamica, formulato dal fisico tedesco Rudolf Clausius (1822-1888), secondo il quale il calore non può trasferirsi spontaneamente da un corpo più freddo a uno più caldo.

Il secondo principio è cruciale per le macchine termiche che convertono calore in lavoro. Nella formulazione proposta da lord Kelvin, equivalente a quella di Clausius come è dimostrabile in modo rigoroso, si afferma che, mentre è sempre possibile trasformare lavoro interamente in calore, non è consentito il processo inverso: è impossibile che una trasformazione abbia come unico risultato l'assorbimento di calore da una sorgente e la sua conversione integrale in lavoro.

In sintesi, il secondo principio stabilisce i limiti intrinseci alla conversione del calore in lavoro. Per dimostrare l'equivalenza tra le formulazioni di Clausius e Kelvin del secondo principio, si procede per assurdo: ipotizzando la falsità di una delle due formulazioni, si dimostra che anche l'altra risulterebbe incongruente.
...
#boxfl(bottom)[== #wolf Il frigorifero <senza_numero>
...
Il primo principio della termodinamica afferma, in termini generali, che l'energia totale dell'universo è costante. Al contrario, il secondo principio introduce delle limitazioni: questa energia non può essere convertita liberamente da una forma all'altra.

Ad esempio, l'energia termica non può spontaneamente trasferirsi da un corpo più freddo a uno più caldo; più precisamente, questa possibilità è estremamente improbabile. Inoltre, secondo il secondo principio della termodinamica, ogni produzione di lavoro è inevitabilmente accompagnata da un aumento di temperatura.

Ciò implica che l'universo tende spontaneamente a trasformare l'energia verso una forma meno utilizzabile, come il calore, che non può essere completamente riconvertito in un'altra forma di energia. Si tratta di un fenomeno noto come "degradazione" dell'energia, con conseguente dispersione nell'ambiente.

Sempre in linea con il secondo principio, le trasformazioni fisiche spontanee seguono una direzione ben definita. Ad esempio, il calore fluisce da un corpo più caldo a uno più freddo e non viceversa. L'acqua su una superficie tende a evaporare, mentre il vapore acqueo non si riconverte spontaneamente in liquido. Analogamente, una palla che rimbalza al suolo smette gradualmente di muoversi fino a fermarsi completamente, a causa dell'attrito.

Questi fenomeni confermano il primo principio della termodinamica, poiché l'energia del sistema viene conservata. Tuttavia, non sono compatibili con il secondo principio, dato che si manifesta la tendenza verso stati energetici più disordinati. 

Un chiaro esempio di irreversibilità si osserva attraverso un sistema fisico composto da due contenitori collegati da una valvola. Inizialmente, tutte le molecole di gas sono contenute nel primo recipiente. Quando la valvola viene aperta, il gas si espande spontaneamente nel secondo contenitore, distribuendosi uniformemente tra i due volumi disponibili.

Sebbene teoricamente le molecole possano rimanere nel primo contenitore o migrare completamente nel secondo, tali configurazioni non si verificano spontaneamente. Una volta completata la distribuzione uniforme del gas tra i due contenitori, risulta altamente improbabile che il sistema ritorni allo stato iniziale con tutte le molecole concentrate nel primo contenitore.

Questo processo irreversibile evidenzia il passaggio spontaneo da uno stato inizialmente ordinato (molecole concentrate) a uno finalizzato alla massima dispersione e disordine (molecole distribuite uniformemente).

Un esempio simile è il fenomeno del passaggio di calore tra un corpo più caldo e uno più freddo: una volta completato, il processo non si inverte spontaneamente. Questo comporta il passaggio del sistema da uno stato iniziale ordinato (un corpo caldo e uno freddo) a uno stato finale più disordinato (i due corpi alla stessa temperatura). Il processo, essendo irreversibile, non può avvenire spontaneamente in senso contrario.

In termini più generali, si può affermare che un sistema fisico isolato soggetto a trasformazioni spontanee tende a evolversi verso uno stato di massimo disordine. Per descrivere questo principio, la fisica ha introdotto una grandezza chiamata entropia, solitamente indicata con il simbolo S, che quantifica il grado di disordine di un sistema.
