...
#intro[La teoria della relatività fu elaborata da Albert Einstein nei primi anni del Novecento con l'obiettivo principale di offrire una visione unificata delle leggi della fisica. Fino a quel momento, le leggi della meccanica classica godevano di una posizione privilegiata rispetto alle leggi dell'elettromagnetismo e dell'ottica, poiché potevano essere considerate invarianti rispetto a tutti i sistemi di riferimento inerziali. Tuttavia, la costanza della velocità della luce, indipendente dalla velocità della sorgente emittente, risultava inconciliabile con i principi tradizionali della relatività classica.

La teoria della relatività si sviluppa quindi come tentativo di armonizzare le leggi naturali all'interno di un unico quadro teorico e si articola in due principali filoni: la relatività ristretta o speciale e la relatività generale, entrambe formulate a distanza di circa un decennio. Nella relatività ristretta, enunciata nel 1905, vengono analizzati i sistemi che si muovono con moto rettilineo uniforme. Al contrario, la relatività generale del 1915 estende tali concetti a sistemi che descrivono moto qualunque.

L'introduzione dei principi relativistici inerenti allo spazio e, soprattutto, al tempo ha profondamente trasformato la concezione tradizionale in cui spazio e tempo erano considerati dimensioni indipendenti. Questa rivoluzione ha influenzato non solo le discipline scientifiche ma anche molteplici ambiti culturali, contribuendo a plasmare la visione del mondo nel suo complesso.]

== Che cos'è la relatività

La teoria della relatività è una comprensione complessa che abbraccia concetti fondamentali come lo spazio, il tempo, l'energia e la gravitazione. Fu formulata da Albert Einstein nel tentativo di unificare i fenomeni meccanici, regolati dalle leggi della meccanica classica di Newton, con i fenomeni elettrici e magnetici descritti dalla teoria dell'elettromagnetismo di Maxwell. 

Questi due insiemi di equazioni si basavano su principi fondamentalmente distinti. Nella meccanica classica, infatti, lo spazio e il tempo erano considerati assoluti, e le leggi del moto dovevano essere valide inalterate per chi osserva sia in quiete che in moto rettilineo uniforme. Dall'altro lato, l'elettromagnetismo affermava che le onde elettromagnetiche si propagano a una velocità finita e costante, quella della luce, indipendente dal moto della sorgente. Questo sembrava contrastare con le leggi della meccanica classica.

Agli inizi del XX secolo, la comunità dei fisici teorici si concentrò sul superamento del dualismo tra fenomeni meccanici ed elettromagnetici, cercando di inserirli in un quadro teorico unico. Ciò includeva l'adattamento dei fenomeni elettromagnetici alle leggi della meccanica classica. Einstein, però, comprese che non erano le leggi dell'elettromagnetismo a dover essere cambiate, bensì quelle della meccanica. Da questa intuizione nacquero i concetti di spazio e tempo relativi, che permettono di descrivere gli eventi osservati da due diversi sistemi di riferimento.

La prima parte della teoria della relatività fu enunciata nel 1905, applicandosi ai sistemi in moto rettilineo uniforme; essa è nota come teoria della relatività ristretta (o speciale). Successivamente, nel 1915, Einstein estese questa teoria ai sistemi in moto accelerato introducendo la teoria della relatività generale.

== I sistemi di riferimento inerziali

I sistemi di riferimento assumono un ruolo cruciale nella fisica. Un sistema di riferimento è costituito dagli elementi geometrici necessari per determinare la posizione di un punto nello spazio e descriverne il moto e le forze che agiscono su di esso. Tra questi, i sistemi di riferimento inerziali rivestono particolare importanza perché su di essi valgono le leggi fondamentali della meccanica classica. 

In tali sistemi, un corpo in quiete o in moto rettilineo uniforme manterrà il suo stato fino a quando non interverrà una forza esterna a modificarlo. In particolare, vale il principio di inerzia: un sistema che si muove con moto rettilineo uniforme è inerziale, mentre un sistema rotante non lo è.

Nell'ambito della meccanica classica, il principio di relatività fu formulato per la prima volta nel 1630 da Galileo Galilei. Questo principio, noto come principio di relatività galileiana, stabilisce che le leggi della meccanica devono essere identiche per due osservatori che adottano come riferimento due sistemi inerziali. Tali sistemi vengono definiti solidali alle stelle fisse o a qualsiasi altro sistema che si muova con velocità costante rispetto alle stelle fisse.

Il principio di relatività formulato da Galileo sostiene che non esiste alcun modo, attraverso esperimenti, per determinare se un osservatore si trovi in un sistema in quiete o in un sistema in movimento rettilineo uniforme. Questo significa che è corretto parlare esclusivamente di moto relativo tra due sistemi, senza poter stabilire quale dei due sia realmente in quiete e quale in movimento.

Per esempio, le leggi che governano il moto di un corpo sono identiche sia per un osservatore fermo sia per uno che viaggia su un treno a velocità costante. Ne consegue che nessuno dei due osservatori può determinare, tramite esperimenti meccanici, se si trovi in quiete o in moto.
...
Invece, il risultato ottenuto fu nullo: non emerse alcuna differenza nelle velocità misurate, dimostrando così che la luce mantiene una velocità costante indipendentemente dal movimento relativo della sorgente o dell'osservatore. Questo esperimento segnò definitivamente l'abbandono della teoria dell'etere e confermò il carattere universale della velocità della luce.

== La relatività ristretta

La teoria della relatività ristretta, o speciale, formulata da Albert Einstein nel 1905, si propone di affrontare le incongruenze presenti nella fisica classica e trova applicazione nei sistemi che si muovono con moto rettilineo uniforme. Successivamente, tale teoria è stata estesa attraverso la relatività generale per includere anche i sistemi soggetti a moti non uniformi.
...
#boxfl(top)[== #wolf La dilatazione del tempo nel decadimento dei muoni <senza_numero>
...
Sul piano matematico, il passaggio da una visione classica a quella relativistica implica l'introduzione delle trasformazioni di Lorentz. Quando le velocità sono molto inferiori rispetto a quella della luce, le trasformazioni di Galileo continuano a essere valide e pienamente utilizzabili anche nella fisica moderna. Analogamente alla meccanica quantistica, non si può dire che la fisica classica venga confutata da nuove teorie come la relatività ristretta; semplicemente essa è circoscritta a un ambito specifico, applicabile ai fenomeni caratterizzati da velocità non relativistiche.
...
Supponiamo ora che l'osservatore sia fermo e che un altro osservatore, in movimento rettilineo uniforme rispetto al primo e dirigendosi verso uno dei due lampi di luce, si trovi esattamente accanto al primo nell'istante in cui, secondo quest'ultimo, i due flash vengono prodotti.
...
Le trasformazioni di Lorentz mostrano che anche la durata di un fenomeno dipende dal sistema di riferimento rispetto al quale viene misurata.
...
Si consideri il seguente scenario: uno dei due gemelli, entrambi ventenni, parte per una spedizione su un'astronave che viaggia ad altissima velocità in una direzione arbitraria, mentre l'altro gemello rimane sulla Terra. Al termine del viaggio, contrassegnato dal ritorno, emergerebbero significative differenze nei ritmi di invecchiamento tra i due fratelli.

Secondo la teoria della relatività ristretta, il gemello a bordo dell'astronave invecchierebbe meno rispetto a quello rimasto sulla Terra. Per esempio, se per il gemello terrestre trascorrono 20 anni, per il gemello astronauta potrebbe passare solo un anno, in funzione della velocità dell'astronave. In tal caso, al momento del ritorno, il gemello che ha viaggiato avrebbe un'età di 21 anni, contro i 40 del gemello rimasto sulla Terra.

Tuttavia, dal punto di vista del gemello astronauta, la situazione potrebbe apparire inversa. Poiché la teoria della relatività ristretta non privilegia alcun sistema di riferimento inerziale, si potrebbe argomentare che sia il gemello terrestre a essere in movimento, mentre il gemello sull'astronave resta fermo. Seguendo questa interpretazione, sarebbe il gemello sull'astronave a mostrare segni di maggiore invecchiamento, mentre quello terrestre apparirebbe più giovane.

Naturalmente, queste due prospettive non possono essere entrambe corrette. Il paradosso è solo apparente, poiché la dilatazione temporale prevista dalla relatività ristretta è applicabile esclusivamente ai sistemi di riferimento inerziali. Sebbene la Terra possa essere considerata un sistema di riferimento inerziale con buona approssimazione, lo stesso non vale per l'astronave, che durante il suo percorso è soggetta a accelerazioni necessarie sia per iniziare sia per concludere il viaggio. Ciò implica che il sistema di riferimento dell'astronave non possa essere considerato valido per questo tipo di analisi.

La teoria della relatività generale, che si occupa anche dei sistemi accelerati, corroborando le previsioni della relatività ristretta, conferma che sarà il gemello spaziale a invecchiare meno al termine del viaggio.
...
Le tre grandezze fondamentali alla base della descrizione di un sistema meccanico sono lunghezza, tempo e massa. 
...
La relatività generale amplia i principi della relatività speciale includendo i sistemi di riferimento non inerziali, ovvero quelli sottoposti ad accelerazione e caratterizzati da velocità variabili. Formulata da Einstein nel 1916, questa teoria introduce un concetto fondamentale: gli effetti osservati nei sistemi non inerziali possono essere equiparati a quelli causati dalla gravità. Pertanto, la relatività generale rappresenta una teoria della gravitazione.

Einstein propose una visione rivoluzionaria rispetto alla concezione newtoniana della gravità: il movimento degli oggetti sottoposti a un campo gravitazionale, come i pianeti attorno al Sole, non deriva da una forza che agisce a distanza. Esso è invece causato dalla deformazione della geometria dello spazio-tempo indotta dalla presenza di masse massicce. Per meglio comprendere il fenomeno, si può pensare a un foglio di plastica teso su un telaio rigido. Se su di esso viene posta una sfera pesante, il foglio si deforma creando una depressione; ogni altro oggetto posto sulla sua superficie tenderà a muoversi verso la sfera seguendo la curvatura indotta.

Allo stesso modo, il moto di una pietra che cade in un campo gravitazionale non dipende direttamente dalla forza esercitata dalla massa del campo, ma dalla curvatura dello spazio-tempo nel punto in cui la pietra si trova.

Lo spazio-tempo determina il comportamento della massa, influenzandone il moto, mentre la massa, a sua volta, modifica lo spazio-tempo attraverso la sua curvatura. Alla base della teoria della relatività generale si trova l'idea fondamentale secondo cui, dato che nella relatività ristretta è impossibile distinguere tra due sistemi di riferimento inerziali, le leggi della fisica devono necessariamente essere universali e valide per tutti i sistemi di riferimento inerziali.

Ma cosa accade nel caso di sistemi di riferimento accelerati? Einstein sostenne che anche in questi casi le leggi fisiche dovessero mantenere la loro validità e universalità. Tale principio viene definito come il principio di invarianza, elemento cardine della relatività generale. Per estendere la teoria ai sistemi di riferimento non inerziali, Einstein introdusse il principio di equivalenza, secondo il quale non è possibile distinguere tra i fenomeni osservabili in un campo gravitazionale uniforme e quelli osservabili in un sistema sottoposto a un'accelerazione costante.

A supporto di tale idea, Einstein propose il celebre esperimento mentale dell'ascensore: un osservatore situato in un ascensore in caduta libera all'interno di un campo gravitazionale uniforme sperimenta effetti del tutto analoghi a quelli percepiti da un osservatore che si trovi in un ascensore accelerato nello spazio vuoto ad accelerazione costante. Il principio di equivalenza non coinvolge solo le leggi della meccanica, ma si estende a tutte le leggi fisiche, inclusa quella dell'elettromagnetismo.

Oltre alla massa, anche la luce risente della curvatura dello spazio-tempo, con la conseguenza che la sua traiettoria può essere deflessa dalla presenza di un campo gravitazionale. Una delle prime conferme sperimentali della relatività generale si verificò nel 1919, durante un'eclissi totale di Sole: in quell'occasione alcuni scienziati furono in grado di misurare la deflessione della luce delle stelle vicine al Sole. I dati raccolti risultarono coerenti con le previsioni teoriche di Einstein, rappresentando una pietra miliare nella validazione della sua teoria.

Considerata una teoria della gravitazione, la relatività generale costituisce uno strumento teorico indispensabile per analizzare e interpretare fenomeni astrofisici e cosmologici. Numerose conferme della validità della teoria sono giunte proprio da queste discipline. Tra queste, una delle più significative riguarda la spiegazione dell'avanzamento del perielio di Mercurio. Il perielio rappresenta il punto dell'orbita ellittica di un pianeta più vicino al Sole; secondo la meccanica classica, tale punto dovrebbe rimanere invariato. Tuttavia, tenendo conto delle perturbazioni dovute alle interazioni gravitazionali con gli altri pianeti, già prima della teoria einsteiniana erano state calcolate correzioni sull'avanzamento del perielio di Mercurio, che risultavano comunque discordanti rispetto alle osservazioni di 43 secondi d'arco per secolo.

La relatività generale riuscì a spiegare questa discrepanza considerando che la curvatura dello spazio-tempo causata dalla massa del Sole determinasse esattamente l'entità dell'avanzamento osservato. Misurazioni recenti del moto del pianeta hanno confermato le previsioni teoriche con una precisione superiore al 99%. 
