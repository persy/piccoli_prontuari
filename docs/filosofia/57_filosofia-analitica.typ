...
#intro[La filosofia analitica si colloca come corrente di pensiero che affronta i problemi filosofici tradizionali attraverso l'analisi del linguaggio con cui vengono formulati. Essa stabilisce un'interconnessione profonda tra pensiero e linguaggio, ritenendo che solo mediante il linguaggio si possa ottenere una chiarificazione esaustiva del pensiero.

Il movimento analitico trova impulso a Cambridge nei primi anni '30 grazie a filosofi come Russell e Moore. In questa fase prevale l'atomismo logico, che interpreta la filosofia come un processo di traduzione delle unità linguistiche complesse in elementi semplici e fondamentali del discorso, con l'obiettivo di individuare i costituenti ultimi della realtà.
...
Il celebre logico, filosofo e divulgatore Bertrand Russell (1872-1970), originario di Trelleck, Galles, affronta nei _Principi della matematica_ (1903), redatti in collaborazione con il matematico e filosofo Alfred North Whitehead, l'ambizioso obiettivo di derivare l'intero corpus della matematica pura da un numero esiguo di concetti logici fondamentali. In tale opera, egli sviluppa in modo sistematico la teoria dei tipi, ideata come soluzione ai paradossi logici legati al concetto di classe, tra cui il celebre esempio del cretese Epimenide, che afferma "tutti i cretesi sono bugiardi". 

La teoria dei tipi introduce una gerarchia di livelli logici tra gli enunciati e ammette come validi solo quegli enunciati che si riferiscono a classi logiche di ordine inferiore rispetto a quella nella quale essi sono espressi. Questa formalizzazione rappresenta un contributo determinante per superare le difficoltà insite nelle strutture logiche paradossali. 

Russell prosegue il suo lavoro con la pubblicazione dell'articolo _Sulla denotazione_ nel 1905, dove formula una teoria delle descrizioni, capace di trasformare qualsiasi proposizione contenente una descrizione in un'altra proposizione equivalente, priva di tale descrizione. Tale approccio permette di analizzare le proposizioni esclusivamente sul piano linguistico, eliminando ogni riferimento ontologico. Ciò fornisce una base teorica per costruire una lingua ideale in cui gli enunciati complessi sono ricondotti a combinazioni di funzioni e elementi primari, aderendo al principio del costruzionismo logico.

=== Senso comune, scienza, filosofia

Nella sua prima opera filosofica di maggiore rilievo, _I problemi della filosofia_ (1912), Russell propone una riflessione sul rapporto tra senso comune, scienza e filosofia. Considerando la scienza, in particolare la fisica, come modello privilegiato per la conoscenza certa, egli contrappone ad essa la conoscenza fornita dal senso comune, che qualifica come vaga e contraddittoria. Tuttavia, la filosofia non può prescindere dal partire dal senso comune; al contrario, deve assimilare e sviluppare i risultati della scienza per evitare insidie quali lo scetticismo e il solipsismo, quest'ultimo inteso come la dottrina che riconosce l'io soggettivo come unica realtà esistente. 

In tale processo chiarificatore, Russell individua una serie di postulati fondamentali – tra cui l'induzione, la causalità, l'esistenza del mondo esterno e delle altre menti, nonché l'affidabilità della memoria – che risultano condivisi sia dalla scienza che dal senso comune. Tuttavia, tali postulati sono privi di una dimostrazione filosofica incontrovertibile, rimanendo contributi filosofici decisivi pur nell'assenza di certezza assoluta.

Sul piano ontologico, Russell si sforza di stabilire un collegamento tra gli oggetti del senso comune e quelli definiti dalla fisica. Una prima risposta a tale quesito è rappresentata dal suo _atomismo logico_, esposto nel 1918 nella _Filosofia dell'atomismo logico_. Secondo questa posizione teorica, il mondo è composto da fatti atomici; essi corrispondono a proposizioni atomiche non ulteriormente scomponibili, come "Socrate è ateniese". 

Attraverso le leggi della logica, tali proposizioni atomiche possono essere combinate per generare proposizioni più complesse, le quali riflettono le configurazioni articolate della realtà. I fatti atomici, nella visione di Russell, si fondano su una sostanza neutrale primitiva, che non è né spirituale né materiale e costituisce il substrato comune tanto delle strutture psicologiche quanto delle fondamenta fisiche.
...
=== L'utilitarismo non edonista

L'etica proposta positivamente da Moore si configura come una forma di cognitivismo non naturalistico. Egli afferma che le proposizioni etiche possono essere vere o false, ma il loro contenuto non è riconducibile a realtà empiriche osservabili. La bontà intrinseca di uno stato di cose, secondo Moore, non può essere sottoposta a dimostrazione attraverso fatti empirici: essa richiede soltanto di valutare se un determinato stato sarebbe buono qualora fosse l'unico a esistere.

Oltre ai giudizi sulla bontà intrinseca, nell'etica mooreana si trovano i giudizi di giustezza. Per Moore, "giusto" significa semplicemente ciò che è causa di un buon risultato. Tuttavia, le conseguenze moralmente rilevanti delle azioni umane possono estendersi indefinitamente nel futuro, rendendo impossibile una conoscenza completa delle implicazioni etiche delle nostre decisioni.

Di conseguenza, Moore suggerisce che per determinare il comportamento eticamente corretto non ci si debba focalizzare sulla conformità alle regole generali, ma piuttosto sui probabili effetti immediati delle proprie azioni. Tali effetti dovrebbero essere valutati principalmente in relazione al benessere personale e a quello delle persone più significative nella vita del singolo individuo.

== Gilbert Ryle

Il professor Gilbert Ryle (Brighton 1900 - Oxford 1976), docente di filosofia presso l'Università di Oxford, è ritenuto uno dei principali fondatori della filosofia analitica incentrata sul linguaggio ordinario. Nel suo articolo _Espressioni sistematicamente fuorvianti_ (1931), Ryle affronta la necessità di rivedere e chiarire determinati usi del linguaggio quotidiano, evidenziando come alcune espressioni grammaticalmente corrette possano divergere dalla struttura ontologica dei fatti a cui si riferiscono, generando così equivoci e talvolta errori concettuali di natura filosofica.

Ad esempio, una frase come "le vacche carnivore non esistono" – classificata da Ryle fra le espressioni "quasi-ontologiche" – potrebbe indurre l'errata concezione che esistano vacche carnivore alle quali attribuire poi la non esistenza. La formulazione corretta e conforme ai fatti sarebbe invece "nulla è insieme vacca e carnivoro", evitando così di alimentare confusi dibattiti metafisici. 
...
Un altro esponente di rilievo della filosofia analitica del linguaggio ordinario è John Langshaw Austin (Lancaster 1911 - Oxford 1960), professore di filosofia morale presso l'Università di Oxford. 

Nel testo _Senso e sensibilia_ (1962), Austin analizza la teoria filosofica secondo cui gli individui non percepiscono mai direttamente gli oggetti materiali – come ad esempio un bastone immerso nell'acqua – ma unicamente il loro riflesso mentale o l'immagine sensoriale, quale quella del bastone che appare spezzato. L'autore mostra come tale concezione emerga da equivoci ed errori nell'uso di termini quali "sembrare" o "apparire", evidenziando l'importanza di una precisazione linguistica.

Nella sua opera _Come fare cose con le parole_ (1962), Austin introduce la distinzione tra espressioni ordinarie con funzione descrittiva – che egli definisce constatative – ed espressioni capaci di compiere atti linguistici, denominate performative. Esempi di quest'ultime includono frasi come "ti battezzo" o "ti prometto", in cui il linguaggio utilizza se stesso per eseguire un'azione.

Tuttavia, attraverso una critica più approfondita, Austin evidenzia che anche molte espressioni apparentemente descrittive possiedono una componente performativa: affermazioni quali "conosco" o "so", ad esempio, implicano non soltanto una descrizione ma anche un impegno implicito del parlante nell'affermare e sostenere determinate verità. 

Per questa ragione, Austin sposta la sua attenzione sul singolo atto linguistico, individuando al suo interno diversi livelli operativi: 
