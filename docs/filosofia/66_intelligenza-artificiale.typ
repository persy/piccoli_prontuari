...
#intro[Il progresso tecnico-scientifico del Novecento, al pari del pensiero postmetafisico, ha imposto numerose sfide alla filosofia tradizionale e ai suoi modelli di razionalità, da secoli considerati veri e indiscutibili. 
...
Tuttavia, è solo nel XX secolo che l'intelligenza artificiale prende forma concreta, grazie all'invenzione degli elaboratori elettronici e al progresso della cibernetica. Quest'ultima si configura come la scienza che, attraverso l'uso di tecniche matematiche avanzate, studia le analogie tra macchine e organismi viventi, con particolare attenzione alle tecniche di controllo, comunicazione e regolazione, e alle loro applicazioni tecnologiche.

=== Reti neurali e pensiero artificiale

Questo primario ambito di ricerca fu inaugurato dal ricercatore americano Norbert Wiener (1894-1964), il quale definì i fondamenti teorici della disciplina nel suo studio intitolato _La cibernetica: controllo e comunicazione nell'animale e nella macchina_ (1948).  

I primi studiosi del pensiero artificiale si prefissero l'obiettivo di riprodurre artificialmente l'attività logica del cervello umano impiegando reti neurali, costruite tramite componenti elettroniche, per imitare la struttura cerebrale composta dalle reti di neuroni.  
...
Mentre Turing e molti teorici dell'intelligenza artificiale arrivarono a rispondere positivamente ai quesiti posti dal dibattito, sostenendo che il comportamento umano è spiegabile in termini computazionali e che il comportamento di una macchina può essere definito intelligente, numerosi filosofi espressero opinioni contrarie.

L'obiezione filosofica più comune a questo criterio, che valuta l'intelligenza di una macchina senza fornire una definizione precisa dell'intelligenza stessa, si basa sull'argomentazione che il pensiero umano è sempre caratterizzato dall'intenzionalità, una proprietà che non sarebbe rintracciabile nelle macchine concepite da Turing.

== I filosofi di fronte all'IA

L'enorme avanzamento tecnologico ha portato alla realizzazione di elaboratori elettronici sempre più sofisticati, passando dalla prima generazione (1946-58) alla quarta (1972), caratterizzata dai circuiti ad alta integrazione che concentrano in un microprocessore (un minuscolo chip di silicio altamente integrato) l'unità centrale di elaborazione.

Le capacità offerte da questa generazione avanzata di elaboratori hanno consentito non solo l'esecuzione automatica di procedure algoritmiche e la dimostrazione dei teoremi, ma anche la risoluzione di problemi formalizzati mediante la simulazione di funzioni cognitive come l'apprendimento e le operazioni inferenziali, inclusi processi di induzione e deduzione.

La ricerca in questo campo ha permesso inoltre lo sviluppo di macchine capaci di analizzare e sintetizzare informazioni e forme attraverso appositi sensori. Dall'elaborazione della voce e delle immagini fino al trattamento del linguaggio naturale, si stanno progettando sistemi capaci di interagire con gli esseri umani tramite comunicazione scritta.

Questi progressi, i cui benefici si riflettono anche sul miglioramento della vita sociale, continuano a riproporre interrogativi sulla natura dell'intelligenza artificiale: se sia possibile ridurre quella umana a una serie di operazioni algoritmico-computazionali e se gli elaboratori elettronici, in costante evoluzione sia per potenza che versatilità, possiedano un'intelligenza paragonabile a quella umana.

Tra i principali studiosi dell'intelligenza artificiale, un posto di rilievo è occupato dallo statunitense Marvin L. Minsky (New York, 1927). Fondatore del Laboratorio di Intelligenza Artificiale presso il Massachusetts Institute of Technology (MIT), Minsky ha elaborato una teoria connessionista nel suo lavoro "La società della mente" (1986). Secondo tale teoria, la mente umana potrebbe essere concepita come una rete costituita da unità semplici di elaborazione, chiamate "agenti", le cui interconnessioni generano i processi psichici.
...
/ Reti neurali e pensiero artificiale: I pionieri nel campo dell'IA cercarono di simulare la logica del cervello umano attraverso reti neurali costruite con componenti elettroniche, riproducendo così la struttura dei neuroni cerebrali. Col tempo, le ricerche sull'IA si sono distaccate da questo approccio: mentre nelle reti neurali si cerca di replicare la struttura fisica del cervello, l'IA si concentra sulla simulazione dei processi mentali senza bisogno di riprodurre fisicamente i meccanismi cerebrali.

/ La macchina e il test di Turing: Alan Mathison Turing, matematico e logico inglese, formulò l'idea di una macchina teorica, nota come "macchina di Turing", capace di imitare le operazioni computazionali di un essere umano leggendo simboli e operando ricorsivamente su di essi. Inoltre, introdusse il famoso test di Turing per determinare se una macchina possa essere considerata intelligente. Secondo questa concezione, il comportamento intelligente umano può essere spiegato in termini computazionali, estendendo tale definizione anche alle macchine.
