...
#boxfl(top)[== #wolf L'acceleretore di particelle <senza_numero> 
...
$ 
  attach("H", tl: "2", bl: "1") + attach("H", tl: "3", bl: "1") -> attach("He", tl: "4", bl: "1") + n + "energia"
$ 
...
$ 
  attach("Li", tl: "6", bl: "3") + n -> attach("He", tl: "4", bl: "1") + attach("H", tl: "3", bl: "1") + "energia"
$ 
