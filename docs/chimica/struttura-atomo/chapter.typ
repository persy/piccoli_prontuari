...
Ad esempio, il simbolo $attach("O", tl: 18, bl: 8)$ (ossigeno-18) rappresenta il nuclide dell'ossigeno con numero atomico 8 e numero di massa 18.
...
Gli isotopi sono atomi dello stesso elemento (con lo stesso numero atomico) ma con differente numero di massa. La maggior parte degli elementi possiede due o tre isotopi. Ad esempio, il carbonio ha isotopi come $attach("C", tl: "12", bl: "6")$, $attach("C", tl: "13", bl: "6")$ e $attach("C", tl: "14", bl: "6")$. La massa atomica di un elemento è calcolata come media ponderata delle masse atomiche dei suoi isotopi e, pertanto, non risulta mai essere un numero intero.
...
#boxfl(bottom)[== #wolf Quanti e spettri di emissione <senza_numero>
